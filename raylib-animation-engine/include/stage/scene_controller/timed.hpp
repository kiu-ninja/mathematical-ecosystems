...
class TimedSceneController: public SceneController {
private:
    int start_time;
    int duration;

public:
    TimedSceneController(float start_time_seconds, float duration_seconds);
    TimedSceneController(int start_time_frames, int duration_frames);
